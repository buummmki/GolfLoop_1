// GolfLoop 골프장 데이터 서비스
// 문화체육관광부 전국 골프장 현황 데이터 기반

class GolfCoursesService {
    constructor() {
        this.database = window.GolfCoursesDatabase || {};
        this.cache = new Map();
    }
...
// 전역 객체로 노출
window.GolfCoursesService = new GolfCoursesService(); 